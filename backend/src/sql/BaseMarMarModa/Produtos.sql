SELECT 
  ...
  FROM [BaseMarMarModa].[dbo].[Cadastro de mercadorias]
  LEFT JOIN [BaseMarMarModa].[dbo].[Cadastro de mercadoriasLojas] ON [Cadastro de mercadoriasLojas].[Código da MercadoriaLoja] = [Cadastro de mercadorias].[Código da Mercadoria]
  LEFT JOIN [BaseMarMarModa].[dbo].[NFe_CST] ON [BaseMarMarModa].[dbo].[NFe_CST].ID = [Cadastro de mercadorias].[CST]
