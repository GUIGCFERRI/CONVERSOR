SELECT
  ...
  FROM [BaseSucataoDoAraanPetrolina].[dbo].[Cadastro de mercadorias]
  LEFT JOIN [BaseSucataoDoAraanPetrolina].[dbo].[NFe_CST] ON [NFe_CST].[ID] = [Cadastro de mercadorias].[CST]
