...
PRODUTO.CSTPIS AS PIS_CODIGO,
PRODUTO.CSTCOFINS AS COFINS_CODIGO,
CONCAT (PRODUTO.observacao, '' ,PRODUTO.INFORMACOESGOURMET) AS OBSERVACOES,
case when PRODUTO.INATIVO = '0' then 'Ativo' else 'Inativo' end as SITUACAO,
...
left join saldoestoque on produto.id=saldoestoque.idproduto and SALDOESTOQUE.idfilial = '1'
