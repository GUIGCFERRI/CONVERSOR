select
  ...
  integrante.PESSOA_FISICA_SEXO as sexo,
  integrante.PESSOA_FISICA_ESTADO_CIVIL as est_civil,
  integrante.OBSERVACAO as observacoes,
  integrante.PESSOA_FISICA_DATA_NASCIMENTO as nascimento,
  integrante.DATA_CADASTRO as cadastro
from integrante
