SELECT
    ...
    TCLIENTE.CLIDATACAD AS CADASTRO,
    ...
    TCLIENTE.CLIDATANASC AS NASCIMENTO,
    TCLIENTE.CLILIMITECRED AS LIMITE_CREDITO,
    TCLIENTE.CLIOBS AS OBSERVACOES,
    TCLIENTE.CLIPAI AS PAI,
    TCLIENTE.CLIMAE AS MAE,
    TCLIENTE.CLIESTCIVIL AS EST_CIVIL,
    TCLIENTE.CLICONJUGE AS CONJUGE
FROM TCLIENTE
LEFT JOIN TCIDADE ON TCIDADE.cidcodigo = TCLIENTE.CLICIDADE
LEFT JOIN TESTADO ON TESTADO.estcodigo = TCIDADE.cidestado
WHERE TCLIENTE.CLIDATACAD IS NOT NULL and TCLIENTE.CLICODIGO > '0' AND CLIPESSOA = 'F'
