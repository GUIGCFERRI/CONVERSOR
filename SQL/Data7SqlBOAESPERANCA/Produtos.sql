SELECT
  ...
  FROM Data7SqlBOAESPERANCA.dbo.Produto
left join Data7SqlBOAESPERANCA.dbo.SaldoEstoque on SaldoEstoque.codproduto = produto.CodProduto
left join Data7SqlBOAESPERANCA.dbo.GrupoProduto on GrupoProduto.CodGrupoProduto = Produto.CodGrupoProduto