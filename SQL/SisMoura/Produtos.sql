...
from MERCEARIAMIGUEL_10075.dbo.Produto
left join MERCEARIAMIGUEL_10075.dbo.Grupo_Produto on produto.Grupo=Grupo_Produto.Codigo
left join MERCEARIAMIGUEL_10075.dbo.produto_cest on produto.Codigo_CEST=produto_cest.Codigo
left join MERCEARIAMIGUEL_10075.dbo.Estoque on estoque.produto = PRODUTO.Codigo
